...
.method private readStorageListLocked()V
    ...
    .line 1196
    .local v24, legacy:Ljava/lang/String;
    const-string v3, "storage_list_lvm"
    ...
    .line 1197
    .local v21, idLvm:I
    const-string v3, "ro.lvm_storage"
    ...
    .line 1198
    .local v25, lvm:Ljava/lang/String;
    const/16 v26, 0x0
    ...
    const-string v12, "readStorageListLocked: using LVM storage list"
    ...
    const-string v32, "got storage path: "
    ...
    const-string v32, " allowMassStorage: "
    ...
    .line 1262
    .local v31, userManager:Lcom/android/server/pm/UserManagerService;
    const/4 v3, 0x0
    ...
    .end local v31           #userManager:Lcom/android/server/pm/UserManagerService;
    :catch_0
    move-exception v16
    ...
    .restart local v22       #index:I
    :cond_d
    invoke-interface/range {v26 .. v26}, Landroid/content/res/XmlResourceParser;->close()V
