...
.field private static final CUSTOM_AUDIO_ASSETS_FILE:Ljava/lang/String; = "audio_assets.xml"

.field private static final CUSTOM_AUDIO_SYMLINK_PATH:Ljava/lang/String; = "/data/system/soundlinks/"
...
.field private static final DEFAULT_SOUND_EFFECTS_PATH:Ljava/lang/String; = null

.field private static final DEFAULT_STREAM_TYPE_OVERRIDE_DELAY_MS:I = 0x1388

.field private static final GROUP_CAMERA_SOUNDS:Ljava/lang/String; = "camera_sounds"

.field private static final GROUP_LOCK_SOUNDS:Ljava/lang/String; = "lock_sounds"

.field private static final GROUP_TOUCH_SOUNDS:Ljava/lang/String; = "touch_sounds"

.field private static final HEADSET_APP_TOFRONT:I = 0x1

.field private static final HEADSET_FRONT_ACTION:I = 0x2

.field private static final HEADSET_KILL_ACTION:I = 0x1

.field private static final HEADSET_NONE_ACTION:I = 0x0
...
.field private mActiveAudioAssetsXml:Lorg/xmlpull/v1/XmlPullParser;

.field private mActiveSoundEffectsPath:Ljava/lang/String;
...
.field private mHeadsetAppStartedByShortcut:Z

.field private mKeyguardManager:Landroid/app/KeyguardManager;

.field private mLinkNotificationWithVolume:Z

.field private mManualSafeMediaVolume:Z
...
.field private mVolumeKeysDefault:I
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/media/AudioService;->DEFAULT_SOUND_EFFECTS_PATH:Ljava/lang/String;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 219
    sget-object v0, Landroid/media/AudioService;->DEFAULT_SOUND_EFFECTS_PATH:Ljava/lang/String;

    iput-object v0, p0, Landroid/media/AudioService;->mActiveSoundEffectsPath:Ljava/lang/String;

    .line 220
    iput-object v5, p0, Landroid/media/AudioService;->mActiveAudioAssetsXml:Lorg/xmlpull/v1/XmlPullParser;
    ...
    .line 484
    iput-boolean v6, p0, Landroid/media/AudioService;->mHeadsetAppStartedByShortcut:Z
...
.method static synthetic access$5000(Landroid/media/AudioService;)Ljava/lang/String;
    ...
    .prologue
    .line 124
    iget-object v0, p0, Landroid/media/AudioService;->mActiveSoundEffectsPath:Ljava/lang/String;
...
.method static synthetic access$7600(Landroid/media/AudioService;)V
    ...
    .prologue
    .line 124
    invoke-direct {p0}, Landroid/media/AudioService;->updateManualSafeMediaVolume()V
...
.method static synthetic access$7802(Landroid/media/AudioService;I)I
    ...
    .prologue
    .line 124
    iput p1, p0, Landroid/media/AudioService;->mVolumeKeysDefault:I
...
.method static synthetic access$8000(Landroid/media/AudioService;)V
    ...
    .prologue
    .line 124
    invoke-direct {p0}, Landroid/media/AudioService;->reloadTouchSoundAssets()V
...
.method static synthetic access$8200(Landroid/media/AudioService;ZILjava/lang/String;)Z
    .locals 1
    .parameter "x0"
    .parameter "x1"
    .parameter "x2"
...
.method static synthetic access$8900(Landroid/media/AudioService;)Landroid/media/MediaFocusControl;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$9100(Landroid/media/AudioService;)Z
    ...
    .prologue
    .line 124
    iget-boolean v0, p0, Landroid/media/AudioService;->mHeadsetAppStartedByShortcut:Z
...
.method static synthetic access$9102(Landroid/media/AudioService;Z)Z
    ...
    .prologue
    .line 124
    iput-boolean p1, p0, Landroid/media/AudioService;->mHeadsetAppStartedByShortcut:Z
...
.method private getActiveStreamType(I)I
    ...
    .line 2850
    :cond_4
    iget v0, p0, Landroid/media/AudioService;->mVolumeKeysDefault:I
...
.method private loadTouchSoundAssetDefaults()V
    ...
    .line 1756
    sget-object v2, Landroid/media/AudioService;->SOUND_EFFECT_FILES:Ljava/util/List;
    ...
    .line 1758
    iget-object v2, p0, Landroid/media/AudioService;->SOUND_EFFECT_FILES_MAP:[[I
    ...
    const-string v2, "/data/system/soundlinks/"

    invoke-direct {v1, v2}, Ljava/io/File;-><init>(Ljava/lang/String;)V

    .line 1765
    .local v1, symlinkDir:Ljava/io/File;
    ...
    const-string v3, "/data/system/soundlinks/camera_click.ogg"

    invoke-direct {p0, v2, v3}, Landroid/media/AudioService;->symlink(Ljava/lang/String;Ljava/lang/String;)V

    .line 1770
    const-string v2, "/system/media/audio/ui/camera_focus.ogg"

    const-string v3, "/data/system/soundlinks/camera_focus.ogg"
    ...
    const-string v3, "/data/system/soundlinks/VideoRecord_start.ogg"
    ...
    const-string v3, "/data/system/soundlinks/VideoRecord_stop.ogg"
    ...
    const-string v4, "/system/media/audio/ui/Lock.ogg"
    ...
    const-string v4, "/system/media/audio/ui/Unlock.ogg"
...
.method private loadTouchSoundAssets()V
    ...
    sget-object v17, Landroid/media/AudioService;->SOUND_EFFECT_FILES:Ljava/util/List;
    ...
    const-string v18, "custom_sound_effects_path"
    ...
    .line 1818
    .local v3, customSoundsPath:Ljava/lang/String;
    if-eqz v3, :cond_6
    ...
    iput-object v3, v0, Landroid/media/AudioService;->mActiveSoundEffectsPath:Ljava/lang/String;
    ...
    iput-object v0, v1, Landroid/media/AudioService;->mActiveAudioAssetsXml:Lorg/xmlpull/v1/XmlPullParser;

    .line 1822
    move-object/from16 v0, p0

    iget-object v0, v0, Landroid/media/AudioService;->mActiveAudioAssetsXml:Lorg/xmlpull/v1/XmlPullParser;
    ...
    const-string v21, "audio_assets.xml"
    ...
    .line 1834
    :goto_1
    invoke-direct/range {p0 .. p0}, Landroid/media/AudioService;->loadTouchSoundAssetDefaults()V

    .line 1837
    :try_start_1
    move-object/from16 v0, p0

    iget-object v15, v0, Landroid/media/AudioService;->mActiveAudioAssetsXml:Lorg/xmlpull/v1/XmlPullParser;

    .line 1839
    const-string v17, "audio_assets"
    ...
    .line 1842
    .local v13, inTouchSoundsGroup:Z
    const/4 v12, 0x0

    .line 1843
    .local v12, inLockSoundsGroup:Z
    const/4 v11, 0x0

    .line 1845
    .local v11, inCameraSoundsGroup:Z
    ...
    instance-of v0, v15, Landroid/content/res/XmlResourceParser;
    ...
    .line 1824
    .end local v11           #inCameraSoundsGroup:Z
    .end local v12           #inLockSoundsGroup:Z
    .end local v13           #inTouchSoundsGroup:Z
    ...
    const-string v18, "Unable to find audio assets XML"
    ...
    const-string v18, "Unable to parse audio assets XML"
    ...
    :cond_6
    sget-object v17, Landroid/media/AudioService;->DEFAULT_SOUND_EFFECTS_PATH:Ljava/lang/String;

    move-object/from16 v0, v17

    move-object/from16 v1, p0

    iput-object v0, v1, Landroid/media/AudioService;->mActiveSoundEffectsPath:Ljava/lang/String;

    .line 1831
    move-object/from16 v0, p0

    iget-object v0, v0, Landroid/media/AudioService;->mContext:Landroid/content/Context;
    ...
    .restart local v11       #inCameraSoundsGroup:Z
    .restart local v12       #inLockSoundsGroup:Z
    .restart local v13       #inTouchSoundsGroup:Z
    ...
    const-string/jumbo v17, "touch_sounds"
    ...
    :try_start_3
    const-class v17, Landroid/media/AudioManager;
    ...
    const-string v18, "audio assets file not found"
    ...
    const-string v19, "Invalid touch sound ID: "
    ...
    const-string v18, "XML parser exception reading touch sound assets"
    ...
    iget-object v0, v0, Landroid/media/AudioService;->mActiveSoundEffectsPath:Ljava/lang/String;
    ...
    const-string v18, "I/O exception reading touch sound assets"
    ...
    const-string/jumbo v18, "unlock_sound"
    ...
    .line 1962
    check-cast v15, Landroid/content/res/XmlResourceParser;
    ...
    const-string v19, "Unrecognized lock sound ID: "
    ...
    .line 1918
    .restart local v14       #name:Ljava/lang/String;
    const-string v17, "camera_sounds"
    ...
    .line 1936
    .restart local v7       #file:Ljava/lang/String;
    const-string v17, "CAMERA_SHUTTER"
    ...
    const-string v18, "/data/system/soundlinks/camera_click.ogg"
    ...
    invoke-direct {v0, v1, v2}, Landroid/media/AudioService;->symlink(Ljava/lang/String;Ljava/lang/String;)V

    goto/16 :goto_4

    .line 1939
    :cond_11
    const-string v17, "CAMERA_FOCUS"
    ...
    const-string v18, "/data/system/soundlinks/camera_focus.ogg"
    ...
    .line 1942
    :cond_12
    const-string v17, "VIDEO_REC_START"
    ...
    const-string v18, "/data/system/soundlinks/VideoRecord_start.ogg"
    ...
    .line 1945
    :cond_13
    const-string v17, "VIDEO_REC_STOP"
    ...
    const-string v18, "/data/system/soundlinks/VideoRecord_stop.ogg"
    ...
    const-string v19, "Unrecognized camera sound ID: "
...
.method private readPersistedSettings()V
    ...
    .line 760
    const-string/jumbo v7, "volume_keys_default"
    ...
    :goto_2
    invoke-static {v0, v7, v4, v11}, Landroid/provider/Settings$System;->getIntForUser(Landroid/content/ContentResolver;Ljava/lang/String;II)I

    move-result v4

    iput v4, p0, Landroid/media/AudioService;->mVolumeKeysDefault:I
...
.method private reloadTouchSoundAssets()V
    .locals 1
...
.method private symlink(Ljava/lang/String;Ljava/lang/String;)V
    .locals 6
    ...
    .line 1788
    .local v2, existing:Ljava/io/File;
    ...
    const-string v5, "Unable to delete symlink: "
    ...
    const-string v5, "Unable to create symlink to "
...
.method private updateManualSafeMediaVolume()V
    .locals 5
    ...
    const-string v3, "manual_safe_media_volume"
    ...
    .line 5017
    .local v0, safeMediaVolumeEnable:I
    if-ne v0, v1, :cond_0

    :goto_0
    iput-boolean v1, p0, Landroid/media/AudioService;->mManualSafeMediaVolume:Z

    .line 5018
    iget-boolean v1, p0, Landroid/media/AudioService;->mManualSafeMediaVolume:Z
...
.method setModeInt(ILandroid/os/IBinder;I)I
    ...
    .line 1647
    .local v2, h:Landroid/media/AudioService$SetModeDeathHandler;
    ...
    .line 1651
    invoke-virtual {v3}, Landroid/media/AudioService$SetModeDeathHandler;->getBinder()Landroid/os/IBinder;
    ...
    .line 1662
    invoke-virtual {v3}, Landroid/media/AudioService$SetModeDeathHandler;->getMode()I
    ...
    .line 1666
    new-instance v3, Landroid/media/AudioService$SetModeDeathHandler;

    .end local v3           #hdlr:Landroid/media/AudioService$SetModeDeathHandler;
    invoke-direct {v3, p0, p2, p3}, Landroid/media/AudioService$SetModeDeathHandler;-><init>(Landroid/media/AudioService;Landroid/os/IBinder;I)V
    ...
    :try_start_0
    invoke-interface {p2, v3, v9}, Landroid/os/IBinder;->linkToDeath(Landroid/os/IBinder$DeathRecipient;I)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-virtual {v9, v10, v3}, Ljava/util/ArrayList;->add(ILjava/lang/Object;)V

    .line 1679
    invoke-virtual {v3, p1}, Landroid/media/AudioService$SetModeDeathHandler;->setMode(I)V
    ...
    invoke-interface {p2, v3, v9}, Landroid/os/IBinder;->unlinkToDeath(Landroid/os/IBinder$DeathRecipient;I)Z
    ...
    iget-object v10, p0, Landroid/media/AudioService;->mStreamVolumeAlias:[I
    ...
    .line 1717
    .local v4, index:I
    iget-object v9, p0, Landroid/media/AudioService;->mStreamVolumeAlias:[I

    aget v9, v9, v8

    const/4 v10, 0x1

    invoke-direct {p0, v9, v4, v0, v10}, Landroid/media/AudioService;->setStreamVolumeInt(IIIZ)V

    .line 1719
    const/4 v9, 0x1

    invoke-direct {p0, v9}, Landroid/media/AudioService;->updateStreamVolumeAlias(Z)V
